...
public class Metro extends Activity implements OnClickListener, OnSharedPreferenceChangeListener{
	private static final String TAG = "Metronome";

//	private TextView tv_title;	
	private TextView tv_NavigateBack;
	
	private Button metro_Button;
	...
	private void initGui() {
		...
		metro_Button = (Button) findViewById(R.id.metro_button);
		metro_Button.setOnClickListener(this);
