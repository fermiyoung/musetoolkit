...
public class Sweep extends Activity implements OnClickListener, OnSharedPreferenceChangeListener{
	private static final String TAG = "Sweep Frequency";

	private TextView tv_NavigateBack;	
	
	private Button sweep_Button;
	...
	private void initGui() {
		...
		sweep_Button = (Button) findViewById(R.id.sweep_button);
		sweep_Button.setOnClickListener(this);
...
//			pdService.startAudio(new Intent(this, Sweep.class), R.drawable.icon, name, "Return to " + name + ".");
