...
public class Wnoise extends Activity implements OnClickListener, OnSharedPreferenceChangeListener{
	private static final String TAG = "WhiteNoise";

	private TextView tv_NavigateBack;	
	
	private Button wnoise_Button;
	...
	private void initGui() {
		setContentView(R.layout.wnoise);
		wnoise_Button = (Button) findViewById(R.id.wnoise_button);
		wnoise_Button.setOnClickListener(this);
...
//			pdService.startAudio(new Intent(this, Wnoise.class), R.drawable.icon, name, "Return to " + name + ".");
