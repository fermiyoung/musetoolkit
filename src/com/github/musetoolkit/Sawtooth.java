...
public class Sawtooth extends Activity implements OnClickListener, OnSharedPreferenceChangeListener{
	private static final String TAG = "SawTooth";

	private TextView tv_NavigateBack;		
	
	private Button sawtooth_Button;
	...
	private void initGui() {
		setContentView(R.layout.sawtooth);
		sawtooth_Button = (Button) findViewById(R.id.sawtooth_button);
		sawtooth_Button.setOnClickListener(this);
...
//			pdService.startAudio(new Intent(this, Sawtooth.class), R.drawable.icon, name, "Return to " + name + ".");
